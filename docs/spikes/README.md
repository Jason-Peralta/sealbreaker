...
| S2 boss animation | Does GeckoLib 5.5.x on NeoForge 26.2 play a server-triggered animation on two clients? | **yes: GeckoLib 5.5.5 (decision 0020); a server-set synced flag played the attack on both clients at the same world tick.** See [s2-boss-animation.md](s2-boss-animation.md) (5 Sep 2026) |
