...
├── gradle/                      wrapper
├── buildSrc/ (later)            convention plugin once three or more subprojects share config
├── sb_core/                     ┐
